...
client.update("Hey, je fais une formation en développement web, donc si tu reçois ce tweet c'est que j'ai réussi mon projet !!!! #Bonjour_monde")
#puts client
#puts handles.sample(5)
handles.sample do |5|
 object.text if 5.is_a?(Twitter::Tweet)
#end 